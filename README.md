...
Right now getting Hexed up and running should be as simple as installing [node](https://nodejs.org/) and [yarn](https://yarnpkg.com/), and then running `yarn install`. Once everything is installed, it can be run using `yarn start`.
